...
class UserInfoVC: UIViewController {
    ...
    func getUserInfo(from username: String) {
    ...
    func configureUIElements(with userInfo: User) {
        ...
        self.addChildVC(childVC: GFUserInfoHeaderVC(user: userInfo), to: self.headerView)
